...
class Seq2Seq(object):
    ...
    # attach any part of the graph that needs to be exposed, to the self
        def __graph__():
            ...
            self.loss = tf.contrib.legacy_seq2seq.sequence_loss(self.decode_outputs, self.lables, loss_weights, yvocab_size)
    ...
    def eval_step(self, sess, eval_batch_gen):
        ...
        # (interchange batch_size and timesteps dimentions)
    ...
    def train(self, train_set, valid_set, sess=None):
        ...
        for i in range(self.epochs):
            try:
                ...
                if i and i%(self.epochs//100) == 0: # make this tunable by the user
                    #save model to disk
                    ...
                    #print stats
                    print("\nModel saved to disk at interation #{}".format(i))
