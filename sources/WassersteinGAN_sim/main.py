...
tf.flags.DEFINE_integer("gen_dimension", "10", "dimension of first layer in generator")
...
def main(argv=None):
    ...
    if FLAGS.model == 0:
        model = GAN(FLAGS.z_dim, FLAGS.batch_size)
    elif FLAGS.model == 1:
    ...
    model.create_network(gen_dim, discriminator_dims, FLAGS.optimizer, FLAGS.learning_rate,
